...
import random
from train_inception import get_inception

# Re-create test_df, test_dataset, and label2idx using the same logic as in training
...
if __name__ == "__main__":
    ...
    for idx in range(total):
        ...
        # Map label to species using test_df
